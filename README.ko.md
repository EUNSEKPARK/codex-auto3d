...
- 3D 빌드: `vendor/img2threejs/docs/TOKEN_COST.md` 기준 객체당 약 8만~18만 토큰(캐릭터 15만~35만). 리뷰 턴 수가 가장 큰 변수입니다.
- 시간: 이미지 1~3분, 빌드 30분~2시간(패스 수·리뷰 횟수에 비례). 렌더·캡처는 턴당 30초 안팎(GPU 있는 Mac 기준).
